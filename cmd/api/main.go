...
func main() {
	...
	flag.IntVar(&cfg.port, "port", 4000, "Set the app port")
	flag.StringVar(&cfg.env, "env", "dev", "Set the app env")
	...
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "Greenlight <no-reply@greenlight.davidortegafarrerons.com>", "SMTP sender")
	flag.Parse()
